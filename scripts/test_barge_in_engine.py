...
def test_barge_in_playback_cutoff():
    ...
    print(f"✓ Synthesized test audio: {audio_path}")
    ...
    print("✓ Audio is actively playing through speakers (is_playing() == True)")
    ...
    print(f"✓ Playback Interrupted: stopped={stopped}")
    print(f"⚡ Measured Cutoff Latency: {cutoff_latency_ms:.2f} ms")
    ...
    print(f"🎯 Target Latency < 150ms Met: {cutoff_latency_ms:.2f}ms (Grade: Excellent)")
    ...
    print("✓ MicrophoneListener.monitor_barge_in_and_record verified")
    ...
    print("✓ VoiceAgent barge-in workflow integrated successfully")
